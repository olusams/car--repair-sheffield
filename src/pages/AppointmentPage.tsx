...
const AppointmentPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead
        title="Schedule Appointment - Maleen Pro"
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">+44 20 7946 0958</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">info@maleenpro.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900">97 W. Irving Park Road<br />London, England SW3 5LA</p>
                      </div>
                    </div>
